// Dotenv package to protect API keys
const dotenv = require('dotenv')
dotenv.config()

// Set URL for each API
const GEONAMES_ROOT = "http://api.geonames.org/searchJSON?q="
const GEONAMES_USERNAME_URL = `&username=${process.env.GEONAMES_USERNAME}`
...
// This is for testing server endpoints with Jest and Supertest 
module.exports = app
...
async function callGeo(req, res) {
    ...
    const geonamesURL = GEONAMES_ROOT + city + GEONAMES_USERNAME_URL + GEONAMES_PARAMS
...
async function callPhoto(req, res) {
    ...
    try {
        ...
        // If no photo was returned for city, get one for the country 
